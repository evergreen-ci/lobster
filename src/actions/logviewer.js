...
export const LOGVIEWER_TOGGLE_SETTINGS_PANEL =
...
export type SearchEventDirection = $Exact<
  $ReadOnly<{
    action: "next" | "prev",
  }>
>;

export type SearchEventSetTerm = $Exact<
  $ReadOnly<{
    action: "search",
    term: string,
  }>
...
export function loadInitialHighlights(
  initialHighlights: Highlight[]
): LoadHighlights {
  return {
