...
const expandableRowsLocalSetting = window.localStorage.getItem(
  "lobster-expandable-rows"
);
...
const initialState: Settings = {
  ...
  expandableRows:
    expandableRowsLocalSetting === null
...
export default function (
  ...
  if (
    action.type !== LOGVIEWER_CHANGE_SETTING ||
    action.payload.value !== "toggle"
  ) {
    return state;
  }
