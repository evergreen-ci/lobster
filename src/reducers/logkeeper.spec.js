...
describe('logkeeperDataResponse', function() {
  test('store-line-gitref', function() {
    ...
    const state = logkeeperDataResponse({lines: [], colorMap: {}, isDone: false}, logkeeperDataSuccess(data.join('\n')));
  ...
  test('chunked', function() {
    ...
    let state = {lines: [], colorMap: {}, isDone: false};
