...
describe('resmoke', function() {
  ...
  test('json logs are formatted correctly', () => {
    ...
    expect(state.lines[10].text).toBe('[js_test:backup_restore_rolling] 2020-03-02T08:52:04.792+0000 d20521 | 2020-03-02T08:52:04.792+0000 I  STORAGE  22262   [initandlisten] \"Timestamp monitor starting\"');
    expect(state.lines[11].text).toBe('');
  })
});
