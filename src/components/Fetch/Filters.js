...
import type { Filter as FilterType } from "../../models";
...
export class Filter extends React.PureComponent<FilterProps> {
  ...
  toggleCaseSensitive = () =>
    this.props.toggleCaseSensitive(this.props.filter.text);
  toggleFilterInverse = () =>
    this.props.toggleFilterInverse(this.props.filter.text);
  ...
  render() {
    return (
      <div className="filter-highlight-lines">
        ...
        <span className="toggle-label">Filter Options</span>
        <ToggleButtonGroup
