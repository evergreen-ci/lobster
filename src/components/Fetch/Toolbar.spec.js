...
const linesArr = [
  {
    lineNumber: 1,
    text:
      "[cpp_integration_test:connection_pool_asio_integration_test] 2018-05-09T17:20:31.322+0000 Starting C++ integration test build",
    gitRef: null,
    port: null,
  },
  {
    lineNumber: 2,
    text:
      "build/integration_tests/connection_pool_asio_integration_test --connectionString=rs/localhost:20250,localhost:20251",
    gitRef: null,
    port: null,
  },
  {
    lineNumber: 3,
    text:
      "[cpp_integration_test:connection_pool_asio_integra…pool_asio_integration_test started with pid 9843.",
    gitRef: null,
    port: null,
  },
  {
    lineNumber: 4,
    text:
      "[cpp_integration_test:connection_pool_asio_integra…ction string = rs/localhost:20250,localhost:20251",
    gitRef: null,
    port: null,
  },
  {
    lineNumber: 5,
    text:
      "[cpp_integration_test:connection_pool_asio_integra…0 I -        [main] 	 going to run test: TestPing",
    gitRef: null,
    port: null,
  },
  {
    lineNumber: 6,
    text:
      "[cpp_integration_test:connection_pool_asio_integra…orkInterfaceASIO-0] Connecting to localhost:20250",
    gitRef: null,
    port: null,
  },
  {
