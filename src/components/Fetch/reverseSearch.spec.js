...
test('Reverse Search', function() {
  ...
  assert.equal(wrapper.instance().state.findIdx, 9);
  ...
  wrapper.instance().findInput.dispatchEvent(shiftEnterEvent);
  assert.equal(wrapper.instance().state.findIdx, 8);
  wrapper.instance().findInput.dispatchEvent(shiftEnterEvent);
  assert.equal(wrapper.instance().state.findIdx, 7);
  ...
  assert.equal(wrapper.instance().state.find, '34');
