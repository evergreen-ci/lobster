...
describe("urlParse-legacy", function () {
  test("merge", function () {
    const queryParams =
      "http://domain.invalid/?scroll=99&bookmarks=0,1,2&url=urlserver&server=serverserver";
  ...
  test("bad-bookmarks", function () {
    ...
    [null, "?bookmarks=randomtext", "?bookmarks=ra,n,domt,ext!"].forEach(
      (value) => {
